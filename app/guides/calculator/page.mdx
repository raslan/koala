...
## How to use the <AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala

<AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala is like your
...
number (e.g., `$20.50`, `€10`) and <AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala will automatically understand it. You can even include a space!
...
- **Numbers with a currency code:** Numbers with a 3 letter currency code like
  ...
  <AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala even fixes
...
- **Write them verbally** (e.g., `10 thousand`). In this case `11.65 million` will
  ...
  - Supported symbols for <AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala:
    - `k`: Thousand (`1,000`)
    - `m`: Million (`1,000,000`)
...
<AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala can handle all
...
Now that we got through all that, try the full power of <AppIcon className='bg-zinc-950 rounded-lg w-5 h-5 inline' /> Koala below!
