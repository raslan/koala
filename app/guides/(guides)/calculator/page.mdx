...
<GuideAlert
  title='Pro Tip!'
  description={`All these examples are fully interactive! Try it out below.`}
/>
...
- also <AppIcon name docs /> even fixes typos and ignores spaces! So `USD100`, `$ 100`, `100usd`, `100 uSd`, `usD100` are all the same.
...
<CalculatorBlock
  hideButtons
  small
  preset='USD1k + 10 million usd + $11,650,000'
/>
